...
from jittor_guided_diffusion.resample import create_named_schedule_sampler
...
from jittor_guided_diffusion.train_util import TrainLoop
jt.flags.use_cuda = 1 # jt.flags.use_cuda 表示是否使用 gpu 训练。

def main():
    args = create_argparser().parse_args()
    logger.configure(dir="train")
